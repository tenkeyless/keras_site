...
- [dice function](/api/losses/regression_losses/#dice-function)
...
`>>> loss_fn = keras.losses.mean_squared_error >>> loss_fn(ops.ones((2, 2,)), ops.zeros((2, 2))) <Array: shape=(2,), dtype=float32, numpy=array([1., 1.], dtype=float32)>`
