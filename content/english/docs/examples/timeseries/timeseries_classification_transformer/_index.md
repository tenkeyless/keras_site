...
{{< card link="https://github.com/keras-team/keras-io/blob/master/examples/timeseries/timeseries_classification_transformer.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
The projection layers are implemented through [`keras.layers.Conv1D`]({{< relref "/docs/api/layers/convolution_layers/convolution1d#conv1d-class" >}}).
