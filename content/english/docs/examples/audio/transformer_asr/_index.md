...
{{< cards cols="2" >}}
{{< card link="https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/audio/ipynb/transformer_asr.ipynb" title="Colab" tag="Colab" tagType="warning">}}
{{< card link="https://github.com/keras-team/keras-io/blob/master/examples/audio/transformer_asr.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
I0000 00:00:1700071380.331418  678094 device_compiler.h:187] Compiled cluster using XLA!  This line is logged at most once for the lifetime of the process.
 ...
 203/203 ━━━━━━━━━━━━━━━━━━━━ 0s 947ms/step - loss: 1.8285
```

```plain
target:     <the relations between lee and marina oswald are of great importance in any attempt to understand oswald#s possible motivation.>
