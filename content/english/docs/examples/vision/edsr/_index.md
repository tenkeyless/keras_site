...
{{< card link="https://github.com/keras-team/keras-io/blob/master/examples/vision/edsr.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
![png](/images/examples/vision/edsr/edsr_11_0.png)
