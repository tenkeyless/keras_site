...
{{< cards cols="2" >}}
{{< card link="https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/image_captioning.ipynb" title="Colab" tag="Colab" tagType="warning">}}
{{< card link="https://github.com/keras-team/keras-io/blob/master/examples/vision/image_captioning.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
![png](/images/examples/vision/image_captioning/image_captioning_17_2.png)

```plain
Predicted Caption:  a black dog is running through the water
```

![png](/images/examples/vision/image_captioning/image_captioning_17_4.png)
