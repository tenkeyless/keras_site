...
> - Original Link : [https://keras.io/examples/graph/gnn_citations/](https://keras.io/examples/graph/gnn_citations/)
...
{{< cards cols="2" >}}
{{< card link="https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/graph/ipynb/gnn_citations.ipynb" title="Colab" tag="Colab" tagType="warning">}}
{{< card link="https://github.com/keras-team/keras-io/blob/master/examples/graph/gnn_citations.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
![png](/images/examples/graph/gnn_citations/gnn_citations_37_0.png)
...
![png](/images/examples/graph/gnn_citations/gnn_citations_55_0.png)
