...
{{< card link="https://github.com/keras-team/keras-io/blob/master/examples/nlp/mlm_training_tpus.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
![png](/images/examples/nlp/mlm_training_tpus/tf_tpu_steps.png)
