...
> - Original Link : [https://keras.io/guides/keras_hub/semantic_segmentation_deeplab_v3/](https://keras.io/guides/keras_hub/semantic_segmentation_deeplab_v3/)
...
{{< card link="https://github.com/keras-team/keras-io/blob/master/guides/keras_hub/semantic_segmentation_deeplab_v3.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
![](/images/guides/keras_hub/semantic_segmentation_deeplab_v3/1*z6ch-2BliDGLIHpOPFY_Sw.png)
...
![png](/images/guides/keras_hub/semantic_segmentation_deeplab_v3/semantic_segmentation_deeplab_v3_18_0.png)
...
Then we create DeepLabV3ImageSegmenter instance. The `num_classes` parameter specifies the number of classes that the model will be trained to segment. `preprocessor` argument to apply preprocessing to image input and masks.
