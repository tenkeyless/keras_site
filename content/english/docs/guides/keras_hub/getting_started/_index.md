...
> - Original Link : [https://keras.io/guides/keras_hub/getting_started/](https://keras.io/guides/keras_hub/getting_started/)
...
We will also set `XLA_PYTHON_CLIENT_MEM_FRACTION`, which frees up the whole GPU for Jax to use from the start.
