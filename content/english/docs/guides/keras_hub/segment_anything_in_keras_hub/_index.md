...
{{< card link="https://github.com/keras-team/keras-io/blob/master/guides/keras_hub/segment_anything_in_keras_hub.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
In this guide, we will show how to use KerasHub's implementation of the [Segment Anything Model](https://github.com/facebookresearch/segment-anything) and show how powerful TensorFlow's and JAX's performance boost is.
...
We can initialize a trained SAM model using KerasHub's `from_preset` factory method. Here, we use the huge ViT backbone trained on the SA-1B dataset (`sam_huge_sa1b`) for high-quality segmentation masks. You can also use one of the `sam_large_sa1b` or `sam_base_sa1b` for better performance (at the cost of decreasing quality of segmentation masks).
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_11_0.png)
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_13_0.png)
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_17_0.png)
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_20_0.png)
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_23_1.png)
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_25_1.png)

Voila! The model understood that the object we wanted to exclude from our mask was the rim of the tyre.

## Text prompts

Finally, let's see how text prompts can be used along with KerasHub's `SegmentAnythingModel`.
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_31_2.png)
...
![png](/images/guides/keras_hub/segment_anything_in_keras_hub/segment_anything_in_keras_hub_35_1.png)
...
Here's a comparison of KerasHub's implementation with the original PyTorch implementation!

![benchmark](/images/guides/keras_hub/segment_anything_in_keras_hub/benchmark.png)
