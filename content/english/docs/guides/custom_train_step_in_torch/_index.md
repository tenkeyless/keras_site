...
> - Original Link : [https://keras.io/guides/custom_train_step_in_torch/](https://keras.io/guides/custom_train_step_in_torch/)
...
{{< card link="https://github.com/keras-team/keras-io/blob/master/guides/custom_train_step_in_torch.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
- If you pass a `torch.utils.data.DataLoader` or a [`tf.data.Dataset`](https://www.tensorflow.org/api_docs/python/tf/data/Dataset), by calling `fit(dataset, ...)`, then `data` will be what gets yielded by `dataset` at each batch.
