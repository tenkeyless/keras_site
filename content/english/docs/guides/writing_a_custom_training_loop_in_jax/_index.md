...
{{< card link="https://github.com/keras-team/keras-io/blob/master/guides/writing_a_custom_training_loop_in_jax.py" title="GitHub source" tag="GitHub">}}
{{< /cards >}}
...
In JAX, gradients are computed via _metaprogramming_: you call the `jax.grad` (or `jax.value_and_grad` on a function in order to create a gradient-computing function for that first function.
