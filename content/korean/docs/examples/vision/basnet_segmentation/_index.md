...
linkTitle: 경계 세그멘테이션을 위한 BASNet
toc: true
weight: 22
type: docs
---
...
**{{< t f_description >}}** DUTS 데이터 세트에 대해 트레이닝된 경계 인식 세그멘테이션 모델입니다.
...
![png](/images/examples/vision/basnet_segmentation/basnet_segmentation_10_0.png)

## Analyze Mask {#analyze-mask}
...
## Building the BASNet Model {#building-the-basnet-model}
...
![png](/images/examples/vision/basnet_segmentation/8jaZ2qs.png)
...
## Residual Refinement Module {#residual-refinement-module}
...
## Combine Predict and Refinement Module {#combine-predict-and-refinement-module}
...
![png](/images/examples/vision/basnet_segmentation/basnet_segmentation_29_1.png)
