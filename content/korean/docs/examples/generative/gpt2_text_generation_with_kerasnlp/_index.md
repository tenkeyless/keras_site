...
KerasNLP는 [Google Bert](https://ai.googleblog.com/2018/11/open-sourcing-bert-state-of-art-pre.html) 및 [GPT-2](https://openai.com/research/better-language-models)와 같은 여러 사전 트레이닝된 모델을 제공합니다.
