---
title: FNet을 사용한 텍스트 분류 (KerasNLP)
linkTitle: FNet 텍스트 분류 (KerasNLP)
toc: true
weight: 3
type: docs
---
...
**{{< t f_description >}}** Text Classification on the IMDb Dataset using [`keras_nlp.layers.FNetEncoder`]({{< relref "/docs/api/keras_nlp/modeling_layers/fnet_encoder#fnetencoder-class" >}}) layer.
