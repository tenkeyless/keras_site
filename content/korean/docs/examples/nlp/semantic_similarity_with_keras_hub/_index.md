---
title: KerasHub를 사용한 시맨틱 유사성
linkTitle: 시맨틱 유사성 (KerasHub)
toc: true
weight: 18
type: docs
---
...
**{{< t f_description >}}** Use pretrained models from KerasHub for the Semantic Similarity Task.
...
{{< card link="https://github.com/keras-team/keras-io/blob/master/examples/nlp/semantic_similarity_with_keras_hub.py" title="GitHub" tag="GitHub">}}
{{< /cards >}}
